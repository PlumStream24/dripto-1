...
import {autoVigenereEncrypt, autoVigenereDecrypt} from '../functions/vigenere-auto-key';

class AutoVigenere extends Component {
    constructor(props) {
        super(props);
        this.state = {
            message : '',
    ...
    return (
        <Container>
            <h1 className="mb-5 mt-5">Auto-Key Vigenere Cypher</h1>
            <Form className="mb-5">
